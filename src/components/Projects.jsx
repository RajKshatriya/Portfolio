...
const projects = [
    {
        id: 1,
        title: 'NeuralChat AI',
        description: 'A real-time AI chatbot platform powered by large language models with streaming responses, conversation history, and multi-model support.',
    ...
    },
    {
        id: 2,
        title: 'CodeCollab',
        description: 'A real-time collaborative code editor with syntax highlighting, live cursor sharing, video chat, and integrated terminal.',
        tech: ['React', 'WebRTC', 'WebSocket', 'Monaco Editor', 'Docker'],
        color: '#00d4ff',
        emoji: '👨‍💻',
        github: '#',
        live: '#',
